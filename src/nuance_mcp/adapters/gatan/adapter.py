...
class GatanGMSAdapter(MicroscopeAdapter):
    ...
    capabilities = frozenset({
        ...
        Capability.STEM_BF, Capability.STEM_ABF, Capability.FOURD_STEM,
        Capability.EELS, Capability.DIFFRACTION, Capability.TILT_SERIES,
        Capability.STAGE, Capability.STAGE_TILT, Capability.OPTICS,
        Capability.DETECTORS,
        Capability.IMAGE_FILTER, Capability.RADIAL_PROFILE,
        Capability.MAX_FFT, Capability.COM_DPC, Capability.MAX_SPOT_MAP,
        Capability.SCRIPT_TEMPLATE, Capability.LIVE_JOBS,
    ...
    def _call(self, method: str, params: dict) -> dict:
        ...
        import json
        msg = {"v": "nuance-mcp-bridge/1.0", "method": method,
               "params": params}
    ...
    def acquire_diffraction(self, exposure_s, camera_length_mm, binning):
        r = self._call("acquire_diffraction", {
            "exposure_s": exposure_s,
            "camera_length_mm": camera_length_mm, "binning": binning})
        return _result_to_image(r)
    ...
    def run_script_template(self, template, params):
        return self._call("run_script_template",
    ...
    def get_live_processing_job_status(self, job_id):
        return self._call("get_live_processing_job_status",
                          {"job_id": job_id})

    def get_live_processing_job_result(self, job_id, include_data=False):
        return self._call("get_live_processing_job_result",
